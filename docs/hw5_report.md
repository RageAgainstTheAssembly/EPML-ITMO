...
The point of HW 6 is setting up MKDocs and Github Action+Pages automation for our existing project.
...
- `mkdocs.ym`l - main documentation configuration (navigation, theme, plugins)
- `docs/index.md` - documentation homepage
- `docs/deployment.md` - deployment guide
- `docs/usage.md` - usage examples
- `docs/reproducibility.md` - step-by-step reproduction guide
- `docs/experiments/index.md` - experiments section landing page
...
![MKDocs home](./figures/mkdocs_home.png)
...
![MKDocs API](./figures/mkdocs_api.png)
...
```
![Experiment report 1](./figures/report_1.png)
![Experiment report 1](./figures/report_2.png)
